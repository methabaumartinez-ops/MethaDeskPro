...
import { Plus, Truck, Mail, Phone, MapPin, Search, ArrowLeft } from 'lucide-react';
import Link from 'next/link';

export default function ProduktionLieferantenPage() {
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 px-2">
                <div>
                    <div className="flex items-center gap-2 mb-1">
                        <Link href={`/${projektId}/teilsysteme`} className="text-muted-foreground hover:text-primary transition-colors">
                    ...
                    <p className="text-muted-foreground font-medium mt-1">Projektbezogene Lieferanten und Partner.</p>
                </div>
                            ...
                            <Table className="border-none rounded-none w-full min-w-full">
                                <TableHeader>
                                    <TableRow className="hover:bg-transparent border-b border-border/50">
                                        ...
                                        <TableHead className="font-bold text-foreground">Aktionen</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                    {filteredItems.length === 0 ? (
                                        ...
                                        filteredItems.map((item) => (
                                            <TableRow key={item.id} className="group hover:bg-muted/50 transition-colors">
                                                ...
                                                <TableCell>
                                                    <Link href={`/${projektId}/lieferanten/${item.id}`}>
