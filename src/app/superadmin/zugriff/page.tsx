        ...
        <div className="min-h-screen text-gray-900 pb-10 relative" style={{ backgroundImage: "url('/construction_bg.png')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
                ...
                <div className="flex-1 w-full max-w-5xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 font-medium">Welche Seiten sieht jede Abteilung im Menü?</p>
                        </div>
                    </div>
                    <button
                        onClick={handleSave}
            ...
            <div className="max-w-5xl mx-auto px-8 py-8 flex gap-6">
                ...
                <div className="w-52 shrink-0 space-y-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-gray-500 mb-3 px-2">Abteilungen</p>
                ...
                <div className="flex-1 space-y-5">
                    ...
                    {PAGE_GROUPS.map(group => (
                        <div key={group.label} className="rounded-2xl border border-gray-200 bg-white overflow-hidden shadow-sm">
                            <div className="bg-gray-50 px-5 py-3 border-b border-gray-200">
                                <p className="text-xs font-black uppercase tracking-widest text-gray-500">{group.label}</p>
                            </div>
